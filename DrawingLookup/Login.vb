...
Public Class Login
    ...
    Private Sub loginSettingBtn_Click(sender As Object, e As EventArgs) Handles loginSettingBtn.Click
        Setting.Show()
        Setting.dbFileTxt.Text = My.Settings.dbFileString
        Setting.dfFileTxt.Text = My.Settings.drawingFolder
